	...
	$('#current_pwd').keyup(function(event) {
		...
		$.ajax({
			...
			success: function(respw){
				if(respw==="false"){
					$('#checkPass').html('<font color="red">Mật khẩu hiện tại không đúng</font>');
				}else{
					$('#checkPass').html('');
				}
			},error: function() {
