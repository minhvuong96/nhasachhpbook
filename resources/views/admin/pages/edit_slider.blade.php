                            ...
                            <div class="col-12">
                                <div class="page-title-box">
                                    <ol class="breadcrumb float-left">
                                        ...
                                        <li class="breadcrumb-item active"><a href="{!!url('/admin/view-sliders')!!}">Danh Sách Slider</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <h4 class="header-title m-t-0 mb-4 mt-4">Sửa Slider</h4>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    	<input type="hidden" name="_token" value="{!!csrf_token()!!}">
                                        <div class="form-group col-lg-6">
                                            <label for="link">Đường dẫn đến bài viết<span class="text-danger">*</span></label>
                                            <input value="{!! old('link', isset($slider) ? $slider->link : null ) !!}" id="link" name="link" type="text" placeholder="Nhập đường dẫn" required
                                                   class="form-control">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="image_current">Hình ảnh hiện tại<span class="text-danger">*</span></label>
                                            <img src="admin_public/upload/sliders/{!!$slider->image!!}" alt="{!!$slider->image!!}" style="height:150px; width:250px;" name="image_current">
                                            <input type="hidden" value="{!!$slider->image!!}" name="image_current">
                                        </div>
                                        <div class="form-group col-lg-6">
                                        ...
                                        <div class="form-group col-lg-2">
                                            ...
                                            <input value="{!! old('position', isset($slider) ? $slider->position : null ) !!}" id="position" class="w-50" name="position" type="number" min="1"  required
                                                   class="form-control">
                                        </div>
                                        <div class="form-group col-lg-6">
