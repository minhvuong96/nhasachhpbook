                            ...
                            <div class="col-12">
                                <div class="page-title-box">
                                    <ol class="breadcrumb float-left">
                                        ...
                                        <li class="breadcrumb-item active"><a href="{!!url('/admin/view-publishers')!!}">Danh Sách Nhà Xuất Bản</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <h4 class="header-title m-t-0 mb-4 mt-4">Sửa Nhà Xuất Bản</h4>
                                    <form action="" method="post">
                                    	<input type="hidden" name="_token" value="{!!csrf_token()!!}">
                                        <div class="form-group col-lg-6">
                                            <label for="name">Tên nhà xuất bản<span class="text-danger">*</span></label>
                                            <input value="{!! old('name', isset($publisher) ? $publisher->name : null)!!}" id="name" name="name" type="text" placeholder="Nhập tên nhà xuất bản" required
                                                   class="form-control">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="email">Email<span class="text-danger">*</span></label>
                                            <input value="{!! old('email', isset($publisher) ? $publisher->email : null)!!}" id="email" name="email" type="email" placeholder="Nhập email nhà xuất bản" required
                                                   class="form-control">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="address">Địa chỉ nhà xuất bản<span class="text-danger">*</span></label>
                                            <input value="{!! old('address', isset($publisher) ? $publisher->address : null)!!}" id="address" name="address" type="text" placeholder="Nhập địa chỉ nhà xuất bản" required
                                                   class="form-control">
                                        </div>
                                        <div class="form-group col-lg-12">
                                            <label for="description">Mô tả<span class="text-danger">*</span></label>
                                            <textarea  name="description" id="description" class="form-control">{!! old('description', isset($publisher) ? $publisher->description : null)!!}</textarea>
                                        </div>
                                        <div class="form-group col-lg-6">
