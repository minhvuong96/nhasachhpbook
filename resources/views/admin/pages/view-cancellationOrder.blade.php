                                ...
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable" class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="action">
                                                    <a class="iconViewCate btn btn-success btn-sm" href="{!!url('/admin/approval-order',$item->id)!!}">Chi tiết</a> 
                                                    <a onclick="return confirm('Bạn có chắc muốn xóa không?');" class="iconViewCate btn btn-danger btn-sm" href="{!!url('/admin/delete-order',$item->id)!!}">Xóa</a>
                                                </span>
                                            </td>
                                        </tr>
                                        @endforeach
