...
@section('title')
Danh Sách Tác Giả - HPBOOK ADMIN
@endsection
@section('css')
<!-- DataTables -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="m-t-0 header-title mb-4"><b>Danh Sách Tác Giả</b></h4>
                                    ...
                                    <table id="datatable" class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="action">
                                                    <a class="iconViewCate text-success" href="{!!url('/admin/edit-author',$item['id'])!!}" data-toggle="tooltip" data-placement="top" title="Sửa tác giả"><i class="fas fa-edit"></i></a>                 
                                                    <a onclick="return confirm('Bạn có chắc muốn xóa không?');" class="iconViewCate text-danger" href="{!!url('/admin/delete-author',$item['id'])!!}" data-toggle="tooltip" data-placement="top" title="Xóa tác giả"><i class="fas fa-trash"></i></a>
                                                </span>
                                            </td>
                                        </tr>
                                        @endforeach
