            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-box">
                        ...
                        <h4 class="header-title m-t-0 mb-4 mt-4">Sửa Quyền</h4>
                        <form action="{!!url('admin/edit-permission', $permission->id)!!}" method="post">
