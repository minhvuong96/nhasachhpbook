...
@section('title')
    Danh Sách Chức Danh - HPBOOK ADMIN
@endsection
@section('css')
    <!-- DataTables -->
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card-box table-responsive">
                        ...
                        <h4 class="m-t-0 header-title mb-4"><b>Danh Sách Chức Danh</b></h4>
                        <a href="{!!url('/admin/add-role')!!}" class="btn btn-success m-3"><i class="fas fa-plus"></i>
                            Thêm</a>
                                    ...
                                    <td>
                                                    <span class="action">
                                                        <a class="iconViewCate text-success"
                                                           href="{{url('/admin/edit-role', $role->id)}}"
                                                           data-toggle="tooltip" data-placement="top"
                                                           title="Sửa chức danh"><i class="fas fa-edit"></i></a>
                                                        <a onclick="return confirm('Bạn có chắc muốn xóa không?');"
                                                           class="iconViewCate text-danger"
                                                           href="{{url('/admin/delete-role', $role->id)}}"
                                                           data-toggle="tooltip" data-placement="top"
                                                           title="Xóa chức danh"><i class="fas fa-trash"></i></a>
                                                    </span>
                                    </td>
                                </tr>
                            @endforeach
