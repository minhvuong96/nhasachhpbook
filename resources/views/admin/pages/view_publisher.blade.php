...
@section('title')
Danh Sách Nhà Xuất Bản - HPBOOK ADMIN
@endsection
@section('css')
<!-- DataTables -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="m-t-0 header-title mb-4"><b>Danh Sách Nhà Xuất Bản</b></h4>
                                    ...
                                    <table id="datatable" class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="action">
                                                    <a class="iconViewCate text-success" href="{!!url('/admin/edit-publisher',$item['id'])!!}" data-toggle="tooltip" data-placement="top" title="Sửa nhà xuất bản"><i class="fas fa-edit"></i></a>                 
                                                    <a onclick="return confirm('Bạn có chắc muốn xóa không?');" class="iconViewCate text-danger" href="{!!url('/admin/delete-publisher',$item['id'])!!}" data-toggle="tooltip" data-placement="top" title="Xóa nhà xuất bản"><i class="fas fa-trash"></i></a>
                                                </span>
                                            </td>
                                        </tr>
                                        @endforeach
