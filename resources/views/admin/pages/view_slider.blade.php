                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="m-t-0 header-title mb-4"><b>Danh Sách Slider</b></h4>
                                    ...
                                    <table id="datatable" class="table table-bordered">
                                        ...
                                        <tr>
                                            <td>{!!$item['id']!!}</td>
                                            <td><img src="admin_public/upload/sliders/{!!$item['image']!!}" style="width=100px; height:75px;" alt="{!!$item['image']!!}"></td>
                                            <td>{!!$item['link']!!}</td>
                                            <td>{!!$item['position']!!}</td>
                                            <td>
                                                <span class="action">
                                                    <a class="iconViewCate text-success" href="{!!url('/admin/edit-slider',$item['id'])!!}" data-toggle="tooltip" data-placement="top" title="Sửa slider"><i class="fas fa-edit"></i></a>                 
                                                    <a onclick="return confirm('Bạn có chắc muốn xóa không?');" class="iconViewCate text-danger" href="{!!url('/admin/delete-slider',$item['id'])!!}" data-toggle="tooltip" data-placement="top" title="Xóa slider"><i class="fas fa-trash"></i></a>
                                                </span>
                                            </td>
                                        </tr>
                                        @endforeach
