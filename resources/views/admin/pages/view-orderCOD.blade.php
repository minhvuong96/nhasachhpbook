...
@section('title')
Danh Sách Đơn Hàng - HPBOOK ADMIN
@endsection
@section('css')
<!-- DataTables -->
                            ...
                            <div class="col-12">
                                <div class="page-title-box">
                                   <ol class="breadcrumb float-left">
                                        ...
                                        <li class="breadcrumb-item active">Đơn Hàng Trả Sau</li>
                                ...
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable" class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="action">
                                                        <a class="iconViewCate btn btn-success" href="{!!url('/admin/approval-order',$item->id)!!}">Chi tiết</a>                 
