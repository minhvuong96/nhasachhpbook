                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <h4 class="header-title m-t-0 mb-4 mt-4">Thêm Tác Giả</h4>
                                    <form action="{!!url('admin/add-author')!!}" method="post">
                                    	<input type="hidden" name="_token" value="{!!csrf_token()!!}">
                                        <div class="form-group col-lg-6">
                                            <label for="name">Tên tác giả<span class="text-danger">*</span></label>
                                            <input id="name" name="name" type="text" placeholder="Nhập tên tác giả" required
                                                   class="form-control">
                                        </div>
