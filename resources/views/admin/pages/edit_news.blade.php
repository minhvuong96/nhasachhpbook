                            ...
                            <div class="col-12">
                                <div class="page-title-box">
                                    <ol class="breadcrumb float-left">
                                        ...
                                        <li class="breadcrumb-item active"><a href="{!!url('/admin/view-news')!!}">Danh Sách Bài Viết</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <h4 class="header-title m-t-0 mb-4 mt-4">Sửa Bài Viết</h4>
                                    <form action="" method="post">
                                    	<input type="hidden" name="_token" value="{!!csrf_token()!!}">
                                        <div class="form-group col-lg-6">
                                            <label for="title">Tiêu đề<span class="text-danger">*</span></label>
                                            <input value="{!! old('title', isset($news) ? $news->title : null) !!}" id="title" name="title" type="text" placeholder="Nhập tiêu đề" required
                                                   class="form-control">
                                        </div>
                                        <div class="form-group col-lg-12">
                                            <label for="content">Nội dung<span class="text-danger">*</span></label>
                                            <textarea name="content" id="content" class="form-control">{!! old('content', isset($news) ? $news->content : null) !!}</textarea>
                                        </div>
                                        <div class="form-group col-lg-6">
