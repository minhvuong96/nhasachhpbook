                        ...
                        <li class="dropdown notification-list">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-lg">
                                ...
                                <div class="slimscroll" style="max-height: 190px;">
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="notify-icon"><img src="admin_public/images/users/avatar-2.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                    ...
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="notify-icon"><img src="admin_public/images/users/avatar-3.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                    ...
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="notify-icon"><img src="admin_public/images/users/avatar-4.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                    ...
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="notify-icon"><img src="admin_public/images/users/avatar-5.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                    ...
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="notify-icon"><img src="admin_public/images/users/avatar-6.jpg" class="img-fluid rounded-circle" alt="" /> </div>
