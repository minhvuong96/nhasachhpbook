                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="{!!url('/admin/index')!!}">
                                    <i class="fi-air-play"></i>{{-- <span class="badge badge-danger badge-pill pull-right">3</span>  --}}<span> Trang Chủ </span>
                                </a>
                            </li>
                            <li>
                                    <a href="javascript: void(0);"><i class="fi-bar-graph-2"></i><span> Thống kê doanh thu </span> <span class="menu-arrow"></span></a>
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fas fa-book"></i><span> Danh Mục Sách</span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fab fa-elementor"></i></i><span> Quản lý đơn hàng</span>@if($countNewOrder + $countNewOrderCOD !=0)
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="javascript: void(0);">+ Đơn Trả Trước @if($countNewOrder!=0)
                                        ...
                                        <ul class="nav-third-level" aria-expanded="false">
                                            <li><a href="{!!url('/admin/new-order')!!}">- Đơn Hàng Mới ({!!$countNewOrder!!})</a></li>
                                            <li><a href="{!!url('/admin/view-order')!!}">- Danh Sách Đơn</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="javascript: void(0);">+ Đơn Trả Sau @if($countNewOrderCOD !=0)
                                        ...
                                        @endif <span class="menu-arrow"></span></a>
                                        <ul class="nav-third-level" aria-expanded="false">
                                            <li><a href="{!!url('/admin/new-order-cod')!!}">- Đơn Hàng Mới ({!!$countNewOrderCOD!!})</a></li>
                                            <li><a href="{!!url('/admin/view-order-cod')!!}">- Danh Sách Đơn</a></li>
                                        </ul>
                                    </li>
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fas fa-book-open"></i><span> Quản Lý Kho </span>@if($countOutOfStock!=0)
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fas fa-comments"></i><span> Bình Luận </span>@if($countNewComment!=0)
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fas fa-user-edit"></i><span> Tác Giả </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fas fa-archive"></i><span> Nhà Xuất Bản </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fas fa-users"></i><span> Thành Viên </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fas fa-newspaper"></i><span> Bài Viết </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fas fa-images"></i><span> Quảng Cáo </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="mdi mdi-google-photos"></i><span> Mã Giảm Giá </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
