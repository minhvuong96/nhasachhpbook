...
//            $user->attachRole($roles);
        ...
        $roles = Role::all();
        return view('admin.pages.add_user', compact('roles'));
    }
    ...
    public function editUser(Request $request, $id)
    {
        ...
        $user = User::find($id);
        $roles = Role::all();
        $rolesOfUser = DB::table('role_user')->where('user_id',$id)->get()->pluck('role_id');
        return view('admin.pages.edit_user', compact('user', 'roles', 'rolesOfUser'));
    }
